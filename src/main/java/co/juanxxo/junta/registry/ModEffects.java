...
public class ModEffects {
    ...
    private static StatusEffect register(String name, StatusEffect effect) {
        return Registry.register(Registries.STATUS_EFFECT, Identifier.of(JuntaCoreMain.MOD_ID, name), effect);
    }

    public static void registerEffects() {
        System.out.println("Registrando efectos para JuntaCoreMain");
    }
}
