...
public class ModDamageTypes {
    ...
    public static final RegistryKey<DamageType> HEROBRINE_MELEE_DAMAGE_TYPE = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.of(JuntaCoreMain.MOD_ID, "herobrine_melee"));
