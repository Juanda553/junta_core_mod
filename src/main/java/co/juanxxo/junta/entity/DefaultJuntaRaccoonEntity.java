...
public class DefaultJuntaRaccoonEntity extends AnimalEntity implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public DefaultJuntaRaccoonEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    protected void playHurtSound(DamageSource source) {
        this.playSound(SoundEvents.ENTITY_AXOLOTL_HURT, 1.0F, 0.8F);
    }
